...
def dice(ws,ls):
   ...
   try:
     ...
     print ("")
     sys.exit()
r = c.get(url,headers=ua,data={"a": "Login","Key": "ea4dae6c290ed25c789e06e185d18152c131151029a321004138eb714657141e": obj["Account"]["Username"],"Password": obj["Account"]["Password"],"Totp": ""})
